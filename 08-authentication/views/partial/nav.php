                ...
                <div class="ml-4 flex items-center md:ml-6">
                    ...
                    <div class="relative ml-3">
                        <div><?php if (isset($_SESSION['user'])) : ?>
                            ...
                            <?php else : ?>
                                <div class="flex-shrink-0">
                                    <a href="<?= '/user' ?>" class="bg-indigo-900 text-white rounded-md px-3 py-2 text-sm font-medium">Register</a>
                                    <a href="<?= '/login' ?>" class="bg-indigo-900 text-white rounded-md px-3 py-2 text-sm font-medium">Login</a>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
                    <?php if (isset($_SESSION['user'])) : ?>
                        <form action="/logout" method="POST">
                            ...
                            <button type="submit"  class="bg-indigo-900 text-white rounded-md ml-5 px-3 py-2 mt-4 text-sm font-medium">Logout</button>
                        </form>
                    <?php endif; ?>
                </div>
            </div>
    ...
    <div class="md:hidden" id="mobile-menu">
        ...
        <div class="border-t border-gray-700 pb-3 pt-4">
            <div class="flex items-center px-5">
                ...
                <?php else : ?>
                    <div class="flex-shrink-0">
                        <p class="text-white">You are not registered</p>
                    </div>
                <?php endif; ?>
                <div class="ml-3">
